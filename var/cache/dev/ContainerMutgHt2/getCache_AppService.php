...
class getCache_AppService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('dju8loBgGn', 0, (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));

                ...
                if ((CoreExtension::getAttribute($this->env, $this->source, $context["a"], "statut", [], "any", false, false, false, 78) == "pause")) {
                    ...
                    yield "                    <div class=\"mt-3 p-3 bg-orange-50 border border-orange-200 rounded-lg\">
                        <p class=\"text-xs font-semibold text-orange-700 mb-1\">
                            ⏸ Annonce suspendue par l'administration
                        </p>
                        ";
                    // line 83
                    if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["a"], "commentaire_admin", [], "any", false, false, false, 83)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        // line 84
                        yield "                        <p class=\"text-xs text-orange-600\">";
                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["a"], "commentaire_admin", [], "any", false, false, false, 84), "html", null, true);
                        yield "</p>
                        ";
                    }
                    // line 86
                    ...
                    <div class=\"flex items-center justify-between mt-3\">
                        <div class=\"flex items-center gap-2\">
                            <span class=\"text-xs text-gray-400\">
                                ";
                // line 92
                yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["a"], "date_publication", [], "any", false, false, false, 92)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["a"], "date_publication", [], "any", false, false, false, 92), "d/m/Y"), "html", null, true)) : ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["a"], "date_creation", [], "any", false, false, false, 92), "d/m/Y"), "html", null, true)));
                yield "
                            </span>
                            ";
                // line 94
                if ((CoreExtension::getAttribute($this->env, $this->source, $context["a"], "statut", [], "any", false, false, false, 94) == "active")) {
                    // line 95
...
$context["a"], "statut", [], "any", false, false, false, 96) == "pause")) {
                    // line 97
                ...
                yield "                        </div>
                        <div class=\"flex gap-2\">
                            <a href=\"";
                // line 101
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("annonce_modifier", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["a"], "id_annonce", [], "any", false, false, false, 101)]), "html", null, true);
                yield "\"
                            ...
                            <form action=\"";
                // line 105
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("annonce_supprimer", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["a"], "id_annonce", [], "any", false, false, false, 105)]), "html", null, true);
                yield "\" method=\"post\">
                                <button type=\"submit\"
...
";
    ...
    {
        return array (  317 => 119,  313 => 117,  295 => 105,  288 => 101,  284 => 99,  280 => 97,  278 => 96,  275 => 95,  273 => 94,  268 => 92,  262 => 88,  258 => 86,  252 => 84,  250 => 83,  244 => 79,  242 => 78,  238 => 76,  231 => 75,  225 => 74,  221 => 73,  216 => 71,  208 => 66,  202 => 63,  195 => 61,  190 => 59,  185 => 56,  181 => 53,  173 => 47,  162 => 44,  160 => 43,  154 => 41,  150 => 38,  146 => 37,  143 => 36,  134 => 30,  126 => 24,  124 => 23,  115 => 17,  108 => 15,  102 => 11,  93 => 9,  89 => 8,  85 => 6,  75 => 5,  58 => 3,  41 => 1,);
    }

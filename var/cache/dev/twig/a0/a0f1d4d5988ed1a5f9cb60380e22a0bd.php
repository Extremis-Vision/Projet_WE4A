...
/* annonces.html.twig */
class __TwigTemplate_17f5e7ae15a5e6a32bf19b7e0bf5d7d6 extends Template
{
    ...
    ";
        ...
        ";
        // line 83
        yield from $this->load("annonce/_liste.html.twig", 83)->unwrap()->yield(CoreExtension::merge($context, ["annonces" => (isset($context["annonces"]) || array_key_exists("annonces", $context) ? $context["annonces"] : (function () { throw new RuntimeError('Variable "annonces" does not exist.', 83, $this->source); })()), "favoris_ids" => (isset($context["favoris_ids"]) || array_key_exists("favoris_ids", $context) ? $context["favoris_ids"] : (function () { throw new RuntimeError('Variable "favoris_ids" does not exist.', 83, $this->source); })())]));
        // line 84
        yield "    </div>
...
{% endblock %}
", "annonces.html.twig", "D:\\br02\\we4a\\projet\\Projet_WE4A\\templates\\annonces.html.twig");
    }
}

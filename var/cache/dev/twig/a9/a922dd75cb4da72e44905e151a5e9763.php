...
/* avis/avis.html.twig */
class __TwigTemplate_94a81180fd36a3b55611a0102029d52d extends Template
{
...
(isset($context["deja_note"]) || array_key_exists("deja_note", $context) ? $context["deja_note"] : (function () { throw new RuntimeError('Variable "deja_note" does not exist.', 47, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
    ...
    ";
        ...
        ";
        // line 104
        if (Twig\Extension\CoreExtension::testEmpty((isset($context["avis"]) || array_key_exists("avis", $context) ? $context["avis"] : (function () { throw new RuntimeError('Variable "avis" does not exist.', 104, $this->source); })()))) {
            // line 105
        ...
        ";
            ...
            yield "            ";
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable((isset($context["avis"]) || array_key_exists("avis", $context) ? $context["avis"] : (function () { throw new RuntimeError('Variable "avis" does not exist.', 114, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["a"]) {
                ...
                // line 119
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::upper($this->env->getCharset(), Twig\Extension\CoreExtension::first($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["a"], "redacteur_prenom", [], "any", false, false, false, 119))), "html", null, true);
                yield "</span>
                        </div>
                        <div>
                            <p class=\"font-semibold text-primary text-sm\">";
                // line 122
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["a"], "redacteur_prenom", [], "any", false, false, false, 122), "html", null, true);
                yield " ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["a"], "redacteur_nom", [], "any", false, false, false, 122), "html", null, true);
                yield "</p>
                            <p class=\"text-[11px] text-tertiary\">";
                // line 123
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["a"], "date_avis", [], "any", false, false, false, 123), "d/m/Y"), "html", null, true);
                yield "</p>
                        </div>
                    </div>
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                    // line 129
                    yield "                                <svg class=\"w-4 h-4 ";
                    yield ((($context["i"] <= CoreExtension::getAttribute($this->env, $this->source, $context["a"], "note", [], "any", false, false, false, 129))) ? ("text-amber-400") : ("text-gray-200"));
                    yield "\"
                                     fill=\"currentColor\" viewBox=\"0 0 24 24\">
                                    <path d=\"M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z\"/>
                                </svg>
                ...
                yield "                        </div>
                        ";
                // line 135
                if ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 135, $this->source); })()), "user", [], "any", false, false, false, 135) && ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 135, $this->source); })()), "user", [], "any", false, false, false, 135), "id", [], "any", false, false, false, 135) == CoreExtension::getAttribute($this->env, $this->source, $context["a"], "redacteur_id", [], "any", false, false, false, 135)) || $this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN")))) {
                    // line 136
                    yield "                            <form method=\"post\" action=\"";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("avis_supprimer", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["a"], "id_avis_utilisateur", [], "any", false, false, false, 136)]), "html", null, true);
                    yield "\"
                                  onsubmit=\"return confirm('Supprimer cet avis ?')\">
                                <input type=\"hidden\" name=\"_token\" value=\"";
                    // line 138
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Bridge\Twig\Extension\CsrfRuntime')->getCsrfToken(("avis_supprimer_" . CoreExtension::getAttribute($this->env, $this->source, $context["a"], "id_avis_utilisateur", [], "any", false, false, false, 138))), "html", null, true);
                    yield "\">
                ...
                ";
                // line 149
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["a"], "contenu", [], "any", false, false, false, 149)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 150
                    yield "                    <p class=\"mt-3 text-sm text-tertiary leading-relaxed\">";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["a"], "contenu", [], "any", false, false, false, 150), "html", null, true);
                    yield "</p>
                ";
                }
                // line 152
...
";
    ...
    {
        return array (  395 => 155,  392 => 154,  385 => 152,  379 => 150,  377 => 149,  373 => 147,  361 => 138,  355 => 136,  353 => 135,  350 => 134,  338 => 129,  334 => 128,  326 => 123,  320 => 122,  314 => 119,  308 => 115,  303 => 114,  292 => 105,  290 => 104,  287 => 103,  284 => 101,  275 => 95,  271 => 93,  268 => 92,  252 => 78,  246 => 73,  234 => 67,  228 => 65,  224 => 64,  219 => 61,  214 => 58,  210 => 57,  203 => 52,  197 => 48,  195 => 47,  190 => 44,  187 => 43,  184 => 42,  178 => 37,  174 => 35,  169 => 33,  165 => 32,  162 => 31,  150 => 26,  146 => 25,  143 => 24,  141 => 23,  134 => 21,  128 => 18,  124 => 16,  121 => 14,  112 => 12,  107 => 11,  98 => 9,  93 => 8,  89 => 5,  79 => 4,  58 => 2,  41 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("{% extends 'base.html.twig' %}
{% block pageTitle %}Avis sur {{ vendeur.prenom }} {{ vendeur.nom }} — AutoMarket{% endblock %}
...
{% endblock %}
", "avis/avis.html.twig", "D:\\br02\\we4a\\projet\\Projet_WE4A\\templates\\avis\\avis.html.twig");
    }
}

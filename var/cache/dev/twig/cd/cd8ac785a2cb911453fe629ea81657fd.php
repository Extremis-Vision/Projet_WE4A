...
class __TwigTemplate_b07088e56a6cbff016c699dc11b755fa extends Template
{
    ...
    ";
        ...
        if ((array_key_exists("interlocuteur", $context) && (isset($context["interlocuteur"]) || array_key_exists("interlocuteur", $context) ? $context["interlocuteur"] : (function () { throw new RuntimeError('Variable "interlocuteur" does not exist.', 68, $this->source); })()))) {
            ...
            ";
            // line 71
            yield "            <div class=\"px-6 py-4 border-b border-gray-100 flex items-center gap-4 flex-none\">
                <div class=\"w-10 h-10 rounded-full bg-primary flex items-center justify-center text-white font-bold text-sm uppercase\">
                    ";
            // line 73
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::first($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["interlocuteur"]) || array_key_exists("interlocuteur", $context) ? $context["interlocuteur"] : (function () { throw new RuntimeError('Variable "interlocuteur" does not exist.', 73, $this->source); })()), "prenom", [], "any", false, false, false, 73)), "html", null, true);
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::first($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["interlocuteur"]) || array_key_exists("interlocuteur", $context) ? $context["interlocuteur"] : (function () { throw new RuntimeError('Variable "interlocuteur" does not exist.', 73, $this->source); })()), "nom", [], "any", false, false, false, 73)), "html", null, true);
            yield "
                </div>
                <div>
                    <p class=\"font-bold text-primary text-sm\">";
            // line 76
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["interlocuteur"]) || array_key_exists("interlocuteur", $context) ? $context["interlocuteur"] : (function () { throw new RuntimeError('Variable "interlocuteur" does not exist.', 76, $this->source); })()), "prenom", [], "any", false, false, false, 76), "html", null, true);
            yield " ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["interlocuteur"]) || array_key_exists("interlocuteur", $context) ? $context["interlocuteur"] : (function () { throw new RuntimeError('Variable "interlocuteur" does not exist.', 76, $this->source); })()), "nom", [], "any", false, false, false, 76), "html", null, true);
            yield "</p>
                    <p class=\"text-xs text-primary/40\">";
            // line 77
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["interlocuteur"]) || array_key_exists("interlocuteur", $context) ? $context["interlocuteur"] : (function () { throw new RuntimeError('Variable "interlocuteur" does not exist.', 77, $this->source); })()), "email", [], "any", false, false, false, 77), "html", null, true);
            yield "</p>
                </div>
            </div>
            ...
            yield "            <div class=\"flex-1 overflow-y-auto px-6 py-6 flex flex-col gap-4\" id=\"messages-container\">
                ";
            // line 83
            if (Twig\Extension\CoreExtension::testEmpty((isset($context["messages"]) || array_key_exists("messages", $context) ? $context["messages"] : (function () { throw new RuntimeError('Variable "messages" does not exist.', 83, $this->source); })()))) {
                // line 84
                ...
                // line 85
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["interlocuteur"]) || array_key_exists("interlocuteur", $context) ? $context["interlocuteur"] : (function () { throw new RuntimeError('Variable "interlocuteur" does not exist.', 85, $this->source); })()), "prenom", [], "any", false, false, false, 85), "html", null, true);
                yield "</strong></p>
                    </div>
                ";
            } else {
                ...
                yield "                    ";
                $context['_parent'] = $context;
                $context['_seq'] = CoreExtension::ensureTraversable((isset($context["messages"]) || array_key_exists("messages", $context) ? $context["messages"] : (function () { throw new RuntimeError('Variable "messages" does not exist.', 88, $this->source); })()));
                foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
                    // line 89
                    yield "                        ";
                    $context["is_mine"] = (CoreExtension::getAttribute($this->env, $this->source, $context["message"], "id_expediteur", [], "any", false, false, false, 89) == CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 89, $this->source); })()), "user", [], "any", false, false, false, 89), "id", [], "any", false, false, false, 89));
                    // line 90
                    yield "                        <div class=\"flex ";
                    yield (((($tmp = (isset($context["is_mine"]) || array_key_exists("is_mine", $context) ? $context["is_mine"] : (function () { throw new RuntimeError('Variable "is_mine" does not exist.', 90, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("justify-end") : ("justify-start"));
                    yield "\">
                            <div class=\"max-w-[70%] flex flex-col ";
                    // line 91
                    yield (((($tmp = (isset($context["is_mine"]) || array_key_exists("is_mine", $context) ? $context["is_mine"] : (function () { throw new RuntimeError('Variable "is_mine" does not exist.', 91, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("items-end") : ("items-start"));
                    yield " gap-1\">

                                ";
                    // line 93
                    if ((($tmp =  !(isset($context["is_mine"]) || array_key_exists("is_mine", $context) ? $context["is_mine"] : (function () { throw new RuntimeError('Variable "is_mine" does not exist.', 93, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        // line 94
                        yield "                                <span class=\"text-xs font-semibold text-primary/50 px-1\">
                                    ";
                        // line 95
                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["interlocuteur"]) || array_key_exists("interlocuteur", $context) ? $context["interlocuteur"] : (function () { throw new RuntimeError('Variable "interlocuteur" does not exist.', 95, $this->source); })()), "prenom", [], "any", false, false, false, 95), "html", null, true);
                        yield "
                                </span>
                                ";
                    }
                    ...
                    yield "
                                <div class=\"px-4 py-3 rounded-2xl text-sm leading-relaxed
                                    ";
                    // line 100
                    yield (((($tmp = (isset($context["is_mine"]) || array_key_exists("is_mine", $context) ? $context["is_mine"] : (function () { throw new RuntimeError('Variable "is_mine" does not exist.', 100, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("bg-secondary text-white rounded-br-sm") : ("bg-gray-100 text-primary rounded-bl-sm"));
                    // line 102
                    yield "\">
                                    ";
                    // line 103
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["message"], "contenu", [], "any", false, false, false, 103), "html", null, true);
                    yield "
                                </div>
                                ...
                                <span class=\"text-[11px] text-primary/30 px-1\">
                                    ";
                    // line 107
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["message"], "date_envoi", [], "any", false, false, false, 107), "d/m/Y à H:i"), "html", null, true);
                    yield "
                                </span>
                            </div>
                        </div>
            ...
            yield "            <div class=\"px-6 py-4 border-t border-gray-100 flex-none\">
                <form action=\"";
            // line 117
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("messagerie_envoyer", ["id_vendeur" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["interlocuteur"]) || array_key_exists("interlocuteur", $context) ? $context["interlocuteur"] : (function () { throw new RuntimeError('Variable "interlocuteur" does not exist.', 117, $this->source); })()), "id_utilisateur", [], "any", false, false, false, 117), "id_annonce" => (isset($context["id_annonce_actif"]) || array_key_exists("id_annonce_actif", $context) ? $context["id_annonce_actif"] : (function () { throw new RuntimeError('Variable "id_annonce_actif" does not exist.', 117, $this->source); })())]), "html", null, true);
            yield "\" method=\"post\"
...
";
    ...
    {
        return array (  377 => 156,  367 => 155,  355 => 149,  340 => 136,  337 => 134,  319 => 119,  314 => 117,  311 => 116,  307 => 113,  304 => 112,  293 => 107,  286 => 103,  283 => 102,  281 => 100,  277 => 98,  271 => 95,  268 => 94,  266 => 93,  261 => 91,  256 => 90,  253 => 89,  248 => 88,  242 => 85,  239 => 84,  237 => 83,  234 => 82,  227 => 77,  221 => 76,  214 => 73,  210 => 71,  207 => 69,  205 => 68,  201 => 66,  196 => 62,  193 => 61,  184 => 57,  180 => 55,  178 => 54,  174 => 53,  170 => 52,  163 => 48,  155 => 45,  145 => 39,  142 => 38,  137 => 35,  131 => 33,  126 => 32,  114 => 22,  112 => 21,  107 => 18,  101 => 15,  98 => 14,  96 => 13,  90 => 9,  86 => 6,  76 => 5,  59 => 3,  42 => 1,);
    }
...
{% endblock %}
", "messagerie/inbox.html.twig", "D:\\br02\\we4a\\projet\\Projet_WE4A\\templates\\messagerie\\inbox.html.twig");
    }
}
